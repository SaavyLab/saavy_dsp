use saavy_dsp::dsp_fluent::{envelope_node::AdsrEnvNode, node_extension::NodeExt, oscillator_node::OscNode, voice_node::{RenderCtx, VoiceNode}};
...
fn main() {
    ...
    println!("first sixty-four samples: {:?}", &buffer[..64.min(buffer.len())]);
