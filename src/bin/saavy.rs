...
//!
//! The primary interface for saavy_dsp. Provides real-time audio synthesis
//! with oscilloscope and spectrum visualization.
//!
//! Run with: cargo run
...
fn render_spectrum(data: &[(f64, f64)]) -> Chart<'_> {
